...
struct DailyChallenge: Identifiable {
    ...
    static let all: [DailyChallenge] = [
        ...
        DailyChallenge(id: "2026-05-31", icon: "🥂", title: "Vorglühen am Bohlenplatz", text: "Mach am 31.05. einen Abstecher zum Vorglühen am Bohlenplatz im Herzen Erlangens und hake die Challenge direkt vor Ort ab.", locationName: "Bohlenplatz", month: 5, day: 31, year: 2026, startHour: 12, startMinute: 0, endHour: 20, endMinute: 0, centerCoordinate: CLLocationCoordinate2D(latitude: 49.59662, longitude: 11.01111), radius: 100, requiresLocationCheckIn: true),
        DailyChallenge(id: "2026-06-01", icon: "🍺", title: "Eine letzte Maß", text: "Trink am 01.06. noch eine letzte Maß und hake die finale Challenge direkt vor Ort ab.", locationName: "T-Kreuzung", month: 6, day: 1, year: 2026, startHour: 10, startMinute: 0, endHour: 20, endMinute: 0, centerCoordinate: CLLocationCoordinate2D(latitude: 49.60756, longitude: 11.00512), radius: 50, requiresLocationCheckIn: true)
    ]
}
